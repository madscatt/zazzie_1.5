...
setup(name='sassie_2',
	...
	packages=['sassie','sassie/util','sassie/analyze','sassie/analyze/chi_square_filter','sassie/analyze/density_plot','sassie/build','sassie/build/build_utilities','sassie/build/pdbscan','sassie/build/pdbrx','sassie/calculate','sassie/calculate/capriqorn','sassie/calculate/em_to_sans','sassie/calculate/sld_mol','sassie/interface','sassie/simulate','sassie/simulate/torsion_angle_md','sassie/simulate/prody','sassie/simulate/two_body_grid','sassie/simulate/energy_minimization','sassie/simulate/monte_carlo','sassie/simulate/monte_carlo/extensions','sassie/simulate/monte_carlo/extensions/overlap','sassie/simulate/monte_carlo/monte_carlo_utilities','sassie/simulate/monte_carlo/monte_carlo_utilities/isopeptide_bond_torsion','sassie/simulate/monte_carlo/monte_carlo_utilities/single_stranded_nucleic_backbone_torsion','sassie/simulate/monte_carlo/monte_carlo_utilities/protein_backbone_torsion','sassie/simulate/monte_carlo/monte_carlo_utilities/double_stranded_nucleic','sassie/simulate/monte_carlo/monte_carlo_utilities/tamc_utilities','sassie/simulate/monomer_monte_carlo','sassie/simulate/complex_monte_carlo','sassie/simulate/energy','sassie/simulate/energy/extensions/','sassie/simulate/energy/extensions/non_bonding','sassie/simulate/constraints','sassie/simulate/prody','sassie/tools','sassie/tools/align', 'sassie/tools/contrast_calculator','sassie/tools/data_interpolation','sassie/tools/extract_utilities','sassie/tools/merge_utilities','sassie/calculate/sascalc','sassie/calculate/sascalc/sascalc_library', 'sassie/calculate/sascalc/sascalc_library/cpp_extension'],
    ...
    Extension('sassie.simulate.monomer_monte_carlo.overlap',['sassie/simulate/monomer_monte_carlo/extensions/overlap/overlap.c']),
    Extension('sassie.simulate.complex_monte_carlo.interres',['sassie/simulate/complex_monte_carlo/extensions/mol_overlap/interres.f'],include_dirs=[numpy_include]),
    Extension('sassie.simulate.monomer_monte_carlo.pairs',['sassie/simulate/monomer_monte_carlo/extensions/pairs/pairs.f'],include_dirs=[numpy_include]),
    Extension('sassie.simulate.two_body_grid.foverlap',['sassie/simulate/two_body_grid/extensions/overlap/foverlap.f'],include_dirs=[numpy_include]),
    Extension('sassie.analyze.density_plot.cube',['sassie/analyze/density_plot/extensions/cube/cube.c']),
    Extension('sassie.analyze.density_plot.renorm',['sassie/analyze/density_plot/extensions/renorm/renorm.c']),
