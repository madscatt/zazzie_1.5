...
def check_interpolate(variables, **kwargs):
    ...
    if(dq <= 0):
        ...
        error.append(
            'maxpoints needs to be greater than 2 : ' + str(maxpoints))
        return error
    ...
    # elif(value == 4):
        ...
        error.append('in your input file, ' + expdata[
                     3:] + ', found that q-values that are not increasing: duplicate points or successive q-values where q[0] < q[1]')
        return error
    # elif(value == 6):
