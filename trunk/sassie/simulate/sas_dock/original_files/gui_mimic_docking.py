...
#import sassie.interface.dockingn_filter as docking_filter
import docking_filter as docking_filter
...
error = docking_filter.check_docking(variables)
if(len(error) > 0):
    print 'error = ', error
    sys.exit()
