...
#prepack_exe = os.path.join(os.path.dirname(sys.executable), 'docking_prepack_protocol.linuxgccrelease')
#docking_exe = os.path.join(os.path.dirname(sys.executable), 'docking_protocol.default.linuxgccrelease')
#fixbb_exe = os.path.join(os.path.dirname(sys.executable), fixbb.default.linuxgccrelease')
#database_path= os.path.join(os.path.dirname(sys.executable), database')
#database_path = database_path + '-nodelay  2>&1 | egrep -vf '

prepack_exe = '/home/james/ROSETTA_3.4/rosetta_bin_linux_2015.19.57819_bundle/main/source/bin/docking_prepack_protocol.linuxgccrelease'
docking_exe='/home/james/ROSETTA_3.4/rosetta_bin_linux_2015.19.57819_bundle/main/source/bin/docking_protocol.default.linuxgccrelease'
fixbb_exe='/home/james/ROSETTA_3.4/rosetta_bin_linux_2015.19.57819_bundle/main/source/bin/fixbb.default.linuxgccrelease'
database_path=' -database /home/james/ROSETTA_3.4/rosetta_bin_linux_2015.19.57819_bundle/main/database -nodelay  2>&1 ' 
...
class simulation():
    ...
    def docking_lr(self, variables, txtOutput):
        ...
        files stored in ~/runname/docking_lr directory:
        outfile:          runname.dcd
        ...
        docking_results = os.path.join(mvars.runname, 'docking')
    ...
    def sascalc_x2(self, variables, txtOutput):
        ...
        chisq_scores = os.path.join(mvars.runname, 'docking')
