...
import sassie.simulate.monte_carlo.pairs as pairs
...
#		print 'back from dihedral_rotate'; sys.stdout.flush()
	...
	rgplot=open('./'+runname+'/monomer_monte_carlo/'+dcdfile+'.all_rg_results_data.txt','a')
	...
	rgplot=open('./'+runname+'/monomer_monte_carlo/'+dcdfile+'.accepted_rg_results_data.txt','a')
